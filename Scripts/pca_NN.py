...
# =============================
species_files = {
    "Human": "Human/Human_pca10_features_kmer_weighted_onehot_with_motif_weight_1.npz",
    "Mouse": "Mouse/Mouse_pca10_features_kmer_weighted_onehot_with_motif_weight_1.npz",
    "Drosophila": "Drosophila/Drosophila_pca10_features_kmer_weighted_onehot_with_motif_weight_1.npz"
}

# =============================
# Output directory
# =============================
BASE_OUTDIR = "NN_PCA_Results_weight_1_nodropout_learning_rate_0.005_epoch_100"
...
for species, file_path in species_files.items():
    ...
    # Save text report
    # -----------------------------
    with open(os.path.join(outdir, "nn_report.txt"), "w") as f:
        f.write(f"{species} — Neural Network on t-SNE features\n")
        f.write("=" * 50 + "\n")
