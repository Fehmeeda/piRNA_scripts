#Simple overlapping (without padding) kmers proability in positive and negative samples separately
...
# =======================================================
# 2. Extract VALID k-mers (remove N, -)
# =======================================================
...
def plot_side_by_side(all_kmers, pdf_pos, pdf_neg, species):
    ...
    plt.title(f"{species}: 3-mer PDF (Pos vs Neg)")
    plt.legend()
    plt.tight_layout()
    plt.show()
